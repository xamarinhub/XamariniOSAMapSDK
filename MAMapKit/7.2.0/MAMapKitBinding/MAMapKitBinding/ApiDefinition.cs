...
namespace MAMapKit
{
	...
	*/
	...
	interface MAMapView_UserLocation
	{
		...
		[Export("distanceFilter")]		double DistanceFilter();		[Export("setUserTrackingMode:")]		void UserTrackingMode(double thevalue);
	...
	interface MAMapViewDelegate
	{
		...
		void MapViewAnnotationViewDidChangeDragState(MAMapView mapView, MAAnnotationView view, MAAnnotationViewDragState newState, MAAnnotationViewDragState oldState);
