...
namespace AMapLocationKit
{
	...
	interface AMapLocationPolygonRegion
	{
		...
		IntPtr Constructor(CLLocationCoordinate2D coordinates, nint count, string identifier);
	}
	...
	interface AMapLocationManagerDelegate
	{
		...
		void AmapLocationManagerDoRequireLocationAuth(AMapLocationManager manager, CLLocationManager locationManager);
		...
		void AmapLocationManagerDidFailWithError(AMapLocationManager manager, NSError error);
		...
		void AmapLocationManagerDidUpdateLocation(AMapLocationManager manager, CLLocation location);
		...
		void AmapLocationManagerDidUpdateLocationReGeocode(AMapLocationManager manager, CLLocation location, AMapLocationReGeocode reGeocode);
		...
		void AmapLocationManagerDidChangeAuthorizationStatus(AMapLocationManager manager, CLAuthorizationStatus status);
		...
		void AmapLocationManagerDidUpdateHeading(AMapLocationManager manager, CLHeading newHeading);
		...
		void AmapLocationManagerDidStartMonitoringForRegion(AMapLocationManager manager, AMapLocationRegion region);
		...
		void AmapLocationManagerDidDetermineStateForRegion(AMapLocationManager manager, AMapLocationRegionState state, AMapLocationRegion region);
		...
		void AmapLocationManagerMonitoringDidFailForRegionWithError(AMapLocationManager manager, AMapLocationRegion region, NSError error);
	}
	...
	interface AMapGeoFenceManager
	{
		...
		void AddPolygonRegionForMonitoringWithCoordinates(CLLocationCoordinate2D coordinates, nint count, string customID);
